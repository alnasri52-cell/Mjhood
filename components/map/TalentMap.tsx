...
function LocateMe({ dir }: { dir: string }) {
    ...
    return (
        <button
            ...
            disabled={locating}
            className="absolute bottom-36 left-3 z-[500] w-10 h-10 bg-white hover:bg-gray-50 rounded-full shadow-md border border-gray-200 flex items-center justify-center transition-all active:scale-95"
