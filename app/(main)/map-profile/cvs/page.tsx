...
import { Plus, FileText, ArrowLeft, Trash2, Edit, MapPin, Briefcase, MessageCircle, Mail } from 'lucide-react';
            ...
            <main className="max-w-3xl mx-auto px-4 py-8">
                {!cv ? (
                    ...
                    <div className="space-y-8">
                        {/* CV Detail View (Matched to Public Profile) */}
                        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden p-6 md:p-8 relative group">

                            {/* Actions (Edit/Delete) - Absolute Positioned */}
                            <div className="absolute top-6 right-6 flex space-x-2">
                                <Link
                                    href={`/cv/edit?id=${cv.id}`}
                                    className="p-2 bg-gray-100 text-gray-500 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition"
                                    title={t('editCV')}
                                >
                                ...
                                <button
                                    ...
                                    className="p-2 bg-gray-100 text-gray-500 hover:text-red-600 hover:bg-red-50 rounded-lg transition"
                            ...
                            <div className="text-center mb-8">
                                <div className="w-24 h-24 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4 text-green-600 text-3xl font-bold uppercase">
                                    {cv.full_name?.charAt(0) || user.email?.charAt(0)}
                                </div>
                                <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">{cv.full_name || 'Your Name'}</h1>
