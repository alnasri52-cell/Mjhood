...
export const translations = {
    en: {
        ...
        fulfilled: 'Fulfilled',
        withinKm: 'Within',
        enableLocationFeed: 'Enable location to see nearby needs',
        noNeedsNearby: 'No needs found nearby',
        tryExpandingRadius: 'Try expanding the search radius',
        noFulfilledNeeds: 'No fulfilled needs yet',
        communityWishesMet: 'When community wishes are met, they appear here',
        addNeed: 'Add a Need',
        ...
        "Bakery": "Bakery",
        "Drive-Thru Kiosk": "Drive-Thru Kiosk",
        ...
        "Park": "Park",
        "ATM / Bank Branch": "ATM / Bank Branch",
    ...
    ar: {
        ...
        servicesLabel: 'خدمات',
        needsLabel: 'احتياجات',
        needsFeed: 'احتياجات المجتمع',
        mostVoted: 'الأكثر تصويتاً',
        newest: 'الأحدث',
        fulfilled: 'مُنجز',
        withinKm: 'ضمن',
        enableLocationFeed: 'فعّل الموقع لعرض الاحتياجات القريبة',
        noNeedsNearby: 'لا توجد احتياجات قريبة',
        tryExpandingRadius: 'جرّب توسيع نطاق البحث',
        noFulfilledNeeds: 'لا توجد احتياجات مُنجزة بعد',
        communityWishesMet: 'عندما تتحقق رغبات المجتمع، تظهر هنا',
        addNeed: 'أضف احتياج',
        yourNeeds: 'احتياجاتك',
        ...
        "Car Wash": "مغسلة سيارات",
        "Gas Station": "محطة وقود",
        "EV Charging": "شحن سيارات كهربائية",
        "Private School": "مدرسة خاصة",
        "Co-working Space": "مساحة عمل مشتركة",
        "Sports Venue": "ملعب رياضي",
        "Park": "حديقة",
        "ATM / Bank Branch": "صراف آلي / فرع بنك",
